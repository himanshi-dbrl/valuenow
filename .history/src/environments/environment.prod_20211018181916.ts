export const environment = {
  ...
  google_client_id: "589054181975-v2s8khbblpb42eqsdlgr6op7m7cn60d7.apps.googleusercontent.com",
 // facebook_client_id: "950887182417532",
  facebook_client_id: "1198716530577673",
  recaptch_site_key: "6LdvQNUUAAAAACCcwl-vc2BClrqsZQh0ZYvn3qjZ",
  //SOCKET_ENDPOINT: 'https://apps.valuenow.net:3000',
  SOCKET_ENDPOINT: 'https://chat.valuenow.net:3000/',
  firebase: {
